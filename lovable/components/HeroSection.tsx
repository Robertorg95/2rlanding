...
const badges = [
  { icon: Layers, text: "Páginas web y rediseños" },
  { icon: Settings, text: "Sistemas internos por alcance" },
  { icon: Puzzle, text: "Implementación flexible por etapas" },
];
    ...
    <div className="relative max-w-7xl mx-auto px-6 py-32 md:py-40 w-full">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight text-primary-foreground font-display">
          Páginas web, rediseños y sistemas internos para empresas que necesitan más orden, presencia y control operativo.
        </h1>
        <p className="mt-6 text-lg md:text-xl leading-relaxed text-primary-foreground/70 max-w-2xl">
          En 2R Develops ayudamos a empresas a mejorar su presencia digital y ordenar procesos internos mediante sitios web, rediseños y sistemas administrativos adaptados a su operación.
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4">
          <a href="#contacto" className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-lg bg-brand-white text-primary font-semibold text-sm hover:bg-brand-white/90 transition-colors">
            Agenda una llamada <ArrowRight size={16} />
          </a>
